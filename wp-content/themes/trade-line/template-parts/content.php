...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php
	  $archive_layout = trade_line_get_option( 'archive_layout' );
		?>
		...
		<?php if ( 'full' === $archive_layout ) :  ?>
			...
			the_content( sprintf(
				...
				wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'trade-line' ), array( 'span' => array( 'class' => array() ) ) ),
